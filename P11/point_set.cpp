...
namespace EMST {
  ...
  void point_set::write_dot(std::ostream& os) const {
    ...
    // Dado que 'neato' usa posiciones, podemos dibujar explícitamente o simplemente listar las
    // conexiones. Para simplificar y cumplir el ejemplo, usamos las posiciones directamente o ids.
